...
model.add(LSTM(units=150, return_sequences=True, input_shape=(29,300)))
...
hist = model.fit(train_X, train_Y, epochs=20, batch_size=1, validation_data=(test_X, test_Y)) #56
